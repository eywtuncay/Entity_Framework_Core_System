...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<IlkUcAyKazanciGorunumu> IlkUcAyKazanciGorunumus { get; set; }
    ...
    public virtual DbSet<VwIlkUcAyToplamKazanci> VwIlkUcAyToplamKazancis { get; set; }

    public virtual DbSet<VwToplamTutar> VwToplamTutars { get; set; }

    public virtual DbSet<VwUrunKategoriTedarikciGorunumu> VwUrunKategoriTedarikciGorunumus { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Asd>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("asd");
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("trg_CalisanEklediktenSonra"));
        ...
        modelBuilder.Entity<IlkUcAyKazanciGorunumu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("IlkUcAyKazanciGorunumu");
        });
        ...
        {
            entity.HasKey(e => e.KitapId).HasName("PK__Kitaplar__89491B0C35068591");

            entity.ToTable("Kitaplar");

            entity.Property(e => e.KitapAdi).HasMaxLength(40);

            entity.HasOne(d => d.Yazar).WithMany(p => p.Kitaplars)
                .HasForeignKey(d => d.YazarId)
                .HasConstraintName("fk_yazarlar");
        });
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb =>
                {
                    tb.HasTrigger("UpdateProductStock");
                    tb.HasTrigger("trg_stokMiktariniAzalt");
                });
        ...
        modelBuilder.Entity<VwIlkUcAyToplamKazanci>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_IlkUcAyToplamKazanci");
        });

        modelBuilder.Entity<VwToplamTutar>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_ToplamTutar");
        ...
        modelBuilder.Entity<VwUrunKategoriTedarikciGorunumu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_UrunKategoriTedarikciGorunumu");

            entity.Property(e => e.KategoriAdi).HasMaxLength(15);
            entity.Property(e => e.TedarikciAdi).HasMaxLength(40);
            entity.Property(e => e.UrunAdi).HasMaxLength(40);
        });

        modelBuilder.Entity<Yazarlar>(entity =>
        {
            entity.HasKey(e => e.YazarId).HasName("PK__Yazarlar__CF636CE1B2515A88");

            entity.ToTable("Yazarlar");

            entity.Property(e => e.DogumYeri).HasMaxLength(50);
            entity.Property(e => e.YazarAd).HasMaxLength(40);
            entity.Property(e => e.YazarSoyad).HasMaxLength(40);
        });
